...
public class WebAPI {
    ...
    @BeforeMethod
    public void setUp(@Optional("false") boolean useCloudEnv, @Optional("sauceLabs") String cloudEnvName, @Optional("windows") String OS,
                      @Optional("10") String os_version, @Optional("chrome") String browserName, @Optional("91") String browserVersion,
                      @Optional("http://www.google.com") String url) throws IOException {
...
// Helper Method
    ...
    public static List<WebElement> getListOfWebElementsByXpath1(WebElement locator) {
        List<WebElement> list = new ArrayList<WebElement>();
        list = driver.findElements(By.xpath(String.valueOf(locator)));
        return list;
    }
